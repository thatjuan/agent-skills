...
If the user's input is sparse, ask focused discovery questions. See [Discovery Framework](references/discovery-framework.md) for the complete question set and competitive analysis approach.
...
2. **Mood & Atmosphere** — Rich sensory description of how the brand feels. Use the [Design Vocabulary](references/concept-articulation.md#design-vocabulary) for precise, evocative language.

3. **Visual Language System** — The complete visual identity as a coordinated system:

   | Element | What to Define |
   |---------|---------------|
   | Color Palette | Primary, secondary, accent, neutrals with emotional rationale. Apply [60-30-10 rule](references/visual-design-system.md#color-system). Describe the palette's personality, not just its colors |
   | Typography | Heading + body type pairing, scale ratio, personality of the typefaces. See [Type Scale Ratios](references/visual-design-system.md#typography-system) |
   | Composition | Grid approach, whitespace philosophy, density, visual weight distribution |
   | Imagery Direction | Photography style (genre, lighting, color treatment, subject), illustration approach, or abstract visual elements |
   | Iconography | Style (outlined/filled/duotone), weight, corner treatment, personality |
   | Texture & Pattern | Surface quality, supporting visual elements, brand patterns |
   | Motion Philosophy | How the brand moves — speed, easing, personality of transitions |
   | Spatial Rhythm | Spacing philosophy — tight and dense or open and breathing |

4. **Application Vision** — Describe how this concept comes to life across key touchpoints:
...
5. **Strategic Rationale** — Connect every visual decision to the business strategy. See [Rationale Framework](references/concept-articulation.md#rationale-framework) for the articulation structure.
...
See [Industry Design Approaches](references/industry-approaches.md) for detailed patterns across:
...
See [Design Psychology](references/design-psychology.md) for:
...
1. **Concept Name** — Evocative, memorable
2. **The Story** — Central narrative and big idea (2-3 sentences)
3. **Mood Description** — Rich sensory language describing the feel
4. **Visual Language** — Complete system description (color, type, composition, imagery, motion)
5. **Key Touchpoint Visions** — How it lives across applications
6. **Why This Works** — Strategic rationale connecting every choice to the brief
7. **Audience Impact** — What the target audience thinks, feels, and does when encountering this brand
...
Current design landscape context informs concepts without dictating them. See [Visual Design System — Current Landscape](references/visual-design-system.md#current-design-landscape) for:
...
|-----------|----------------|
| [Discovery Framework](references/discovery-framework.md) | During Phase 1 — extracting the creative brief and analyzing the competitive landscape |
| [Visual Design System](references/visual-design-system.md) | During Phase 3 — defining color, typography, composition, spacing, and motion systems |
