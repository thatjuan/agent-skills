...
const CONFIG = {
  ...
  brand: {
    name: 'Marginalia',
    shortName: 'Marginalia',
    description: 'A literary monthly — curated independent-bookshop reading, one book at a time.',
    themeColor: '#1A1816',
