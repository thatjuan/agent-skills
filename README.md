...
- **[batch-implement](./skills/engineering/batch-implement/SKILL.md)** — Implement a batch of issues autonomously via lean-context subagent fan-out: stacked branches, one PR per issue, build check only, no check-ins.
